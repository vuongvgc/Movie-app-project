      ...
      return (
        <div key={index} className="col-3 my-2 ">
          <div className="card text-left top__Search ">
            ...
            <img
              style={{ width: "100%" }}
              className="card-img-top  img__topSearch img-fluid "
              src={phim.hinhAnh}
              alt={phim.hinhAnh}
            />
            <div className="card-body">
              <h5 className="card-title top__Search__title text-center">
                {phim.tenPhim}
              </h5>
            </div>
          </div>
      ...
      return (
        <div key={index} className="col-3 my-2">
          <div className="card text-left top__Search ">
            ...
            />
            <div className="card-body">
              <h5 className="text-center card-title top__Search__title">
                {phim.tenPhim}
              </h5>
            </div>
          </div>
      ...
      <div className="mt-5 container ">
        <ul className="nav nav-pills mb-3  " id="pills-tab" role="tablist">
          <li className="nav-item my-2" role="presentation">
            <button
              className="nav-link  top__Search__link active"
              id="pills-home-tab"
              data-bs-toggle="pill"
          ...
          <li className="nav-item  my-2" role="presentation">
            <button
              className="nav-link top__Search__link"
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <div className="container">
              <Slider {...settings}>{renderDanhSachPhimHot()}</Slider>
              {/* <div className="display-4"></div>
                            <div className="row">
                                {renderDanhSachPhimHot()}
                            </div> */}
